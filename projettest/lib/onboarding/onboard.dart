...
class _OnBoardState extends State<OnBoard> {
  int currentIndex = 0;
  //Un contrôleur de page vous permet de manipuler quelle page est visible dans un PageView .
  //late signifie appliquer les contraintes de cette variable au moment de l'exécution plutôt qu'au moment de la compilation"
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: PageView.builder(
            ...
            physics: NeverScrollableScrollPhysics(),//ne permet pas à l'utilisateur de faire défiler.
